...
# GMM system for NNET
steps/train_quick.sh --cmd "$train_cmd" 4200 40000 "$TRAINDIR" data/lang exp/tri3a_ali exp/tri4a || exit 1;

steps/align_fmllr.sh --cmd "$train_cmd" "$TRAINDIR" data/lang exp/tri4a exp/tri4a_ali || exit 1;	

utils/mkgraph.sh data/lang_bi_small exp/tri4a exp/tri4a/graph || exit 1;
